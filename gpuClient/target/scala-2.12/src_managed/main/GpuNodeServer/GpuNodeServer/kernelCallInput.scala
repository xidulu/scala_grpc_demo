...
final case class kernelCallInput(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): GpuNodeServer.GpuNodeServer.kernelCallInput = {
    ...
    def companion = GpuNodeServer.GpuNodeServer.kernelCallInput
}

object kernelCallInput extends com.trueaccord.scalapb.GeneratedMessageCompanion[GpuNodeServer.GpuNodeServer.kernelCallInput] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[GpuNodeServer.GpuNodeServer.kernelCallInput] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): GpuNodeServer.GpuNodeServer.kernelCallInput = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[GpuNodeServer.GpuNodeServer.kernelCallInput] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = GpuNodeServerProto.javaDescriptor.getMessageTypes.get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = GpuNodeServerProto.scalaDescriptor.messages(2)
  ...
  lazy val defaultInstance = GpuNodeServer.GpuNodeServer.kernelCallInput(
  )
  implicit class kernelCallInputLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, GpuNodeServer.GpuNodeServer.kernelCallInput]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, GpuNodeServer.GpuNodeServer.kernelCallInput](_l) {
